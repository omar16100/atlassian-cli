...
| --- | --- | --- | --- |
| Phase 2: Jira CLI | ✅ 100% – Issue CRUD, projects, automation, bulk ops, attachments and raw API passthrough complete | ✅ 21 Wiremock integration tests, plus 23 end-to-end tests driving the built binary (attachments, raw API) added in 0.5.0 | ⚠️ In progress – add deep-dive guides/workflows |
